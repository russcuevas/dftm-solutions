...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <a href="{{ route('admin.incoming.show', $batch->id) }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-eye"></i> View Slip
                </a>
                <a href="{{ route('admin.incoming.print', $batch->id) }}" target="_blank" class="btn btn-outline btn-sm">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="company_name" list="companySuggestions"
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="brand" list="brandSuggestions" class="form-control batch-header-input"
        ...
        <div class="card-footer" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 8px;">
                <a href="{{ route('admin.incoming.show', $batch->id) }}" class="btn btn-primary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const getItemsUrl = '{{ route('admin.incoming.items', $batch->id) }}';
            const saveItemUrl = '{{ route('admin.incoming.saveItem', $batch->id) }}';
            const deleteItemUrl = '{{ url('admin/incoming/' . $batch->id . '/item') }}';
            const saveHeaderUrl = '{{ route('admin.incoming.saveHeader', $batch->id) }}';
