...
@section('title', 'New Incoming Transmittal')
@section('page_title', 'Create Incoming Transmittal')
    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle">Enter incoming transmittal details (Units can be scanned continuously in Edit/Scan mode)</div>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
                        ...
                        <a href="{{ route('admin.clients.index') }}" target="_blank" style="font-size: 0.75rem; color: var(--dftm-accent); text-decoration: none; font-weight: 600;">
            ...
            <div class="form-group" style="margin-top: 18px;">
                ...
                <textarea name="notes" class="form-control" rows="3" placeholder="Optional notes about courier, package condition, transmittal reference...">{{ old('notes') }}</textarea>
            </div>
        </div>
