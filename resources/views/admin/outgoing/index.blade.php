...
<div class="card" style="margin-bottom: 20px;">
    <div class="card-header">
        ...
        @if($selectedBatch)
            <div style="display: flex; align-items: center; gap: 10px;">
                <a href="{{ route('admin.outgoing.print', ['batch_id' => $selectedBatch->id]) }}" target="_blank" class="btn btn-primary">
                    <i class="bi bi-printer"></i> Print Outgoing Slip
                </a>
                <button type="button" class="btn btn-outline" data-bs-toggle="modal" data-bs-target="#recordReleaseModal" onclick="document.getElementById('releaseModal').style.display='flex';">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="{{ route('admin.traceability.index', ['batch_id' => $selectedBatch->id]) }}" class="btn btn-outline btn-sm" title="View in Traceability">
    ...
    @else
        <div style="text-align: center; padding: 60px 20px; color: var(--dftm-slate);">
            ...
            <a href="{{ route('admin.traceability.createBatch') }}" class="btn btn-primary" style="margin-top: 8px;">
...
<div id="releaseModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(15, 23, 42, 0.6); z-index: 9999; align-items: center; justify-content: center;">
    <div style="background: #FFFFFF; width: 90%; max-width: 500px; border-radius: 12px; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.2);">
        <form action="{{ route('admin.outgoing.release') }}" method="POST">
            @csrf
