        ...
        <div class="card-body" style="padding: 16px 20px;">
            <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 14px;">
                <div style="display: flex; align-items: center; gap: 12px; flex: 1; min-width: 320px;">
                    ...
                    <select id="activeBatchSelector" class="form-select" style="max-width: 380px; font-weight: 700; border-color: var(--dftm-accent);" onchange="location.href='{{ route('encoder.traceability.index') }}?batch_id=' + this.value;">
