...
@section('content')
<form action="{{ route('encoder.incoming.update', $batch->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="{{ route('encoder.incoming.show', $batch->id) }}" class="btn btn-outline">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mono" value="{{ $batch->slip_no }}" disabled style="background: #F1F5F9; font-weight: 700;">
                </div>
                <div class="form-group">
                    <label class="form-label">Batch Number</label>
                    <input type="text" name="batch_no" class="form-control" value="{{ old('batch_no', $batch->batch_no) }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Company Name</label>
                    <input type="text" name="company_name" list="companySuggestionsEncoder" class="form-control" value="{{ old('company_name', $batch->company_name) }}" placeholder="Enter Company / Client Name">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_delivered" class="form-control" value="{{ old('date_delivered', $batch->date_delivered ? $batch->date_delivered->format('Y-m-d') : '') }}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="brand" list="brandSuggestionsEncoder" class="form-control" value="{{ old('brand', $batch->brand) }}" placeholder="Enter Brand">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="status" class="form-control" value="{{ old('status', $batch->status) }}" placeholder="e.g. In process / For repair">
                </div>
                <div class="form-group">
                    <label class="form-label">Item Description</label>
                    <input type="text" name="item_description" class="form-control" value="{{ old('item_description', $batch->item_description) }}">
                </div>
            </div>
            ...
            <div class="subtable-container">
                <div class="subtable-header">
                    <div>
                        ...
                        <div style="font-size: 0.78rem; color: var(--dftm-slate);">Update serial numbers, MAC addresses, and box numbers, or add new units to this batch</div>
                    </div>
                ...
                <div id="subtableRows">
                    ...
                    <div class="subtable-row" style="grid-template-columns: 40px 2fr 2fr 1.2fr 40px;">
                        ...
                        <div>
                            <input type="text" name="box_no[]" class="form-control" value="{{ $item->box_no }}" placeholder="Box No">
                        </div>
                        <div>
                    ...
                    <div class="subtable-row" style="grid-template-columns: 40px 2fr 2fr 1.2fr 40px;">
                        ...
                        <div><input type="text" name="serial_number[]" class="form-control mono" placeholder="Serial Number"></div>
                        <div><input type="text" name="mac_address[]" class="form-control mono" placeholder="MAC Address"></div>
                        <div><input type="text" name="box_no[]" class="form-control" placeholder="Box No"></div>
                        <div>
