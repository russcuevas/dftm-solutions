    ...
    <div class="card">
        <div class="card-header">
            ...
            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                ...
                <a href="{{ route('encoder.incoming.print', $transmittal->id) }}" target="_blank" class="btn btn-outline btn-sm">
                    <i class="bi bi-printer"></i> Print Report
                </a>
                <a href="{{ route('encoder.incoming.show', $transmittal->id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="card-footer" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display: flex; gap: 8px;">
                <a href="{{ route('encoder.incoming.show', $transmittal->id) }}" class="btn btn-primary">
