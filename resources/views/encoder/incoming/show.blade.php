...
<div class="card">
    <div class="card-header">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="{{ route('encoder.incoming.print', $transmittal->id) }}" target="_blank" class="btn btn-primary btn-sm">
                <i class="bi bi-printer"></i> Print Report
            </a>
            <a href="{{ route('encoder.incoming.edit', $transmittal->id) }}" class="btn btn-accent btn-sm">
