...
@section('content')
<form action="{{ route('encoder.outgoing.update', $slip->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle">Modify outgoing header information, SI/DR numbers, or serialized item rows</div>
            </div>
            <div style="display: flex; gap: 10px;">
                <a href="{{ route('encoder.outgoing.show', $slip->id) }}" class="btn btn-outline">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="company_name" list="companySuggestionsEncoder" class="form-control" value="{{ old('company_name', $slip->company_name) }}" placeholder="Enter Company Name">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="brand" list="brandSuggestionsEncoder" class="form-control" value="{{ old('brand', $slip->brand) }}" placeholder="Enter Brand">
