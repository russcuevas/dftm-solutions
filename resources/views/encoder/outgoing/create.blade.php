...
@section('title', 'Encode Outgoing Repair Slip')
@section('page_title', 'Encode Outgoing Repair Slip')

@section('content')
<form action="{{ route('encoder.outgoing.store') }}" method="POST" id="outgoingForm">
    @csrf

    <div class="card">
        <div class="card-header">
            <div>
                <div class="card-title"><i class="bi bi-box-arrow-up-right"></i> Outgoing Repair Release Entry</div>
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_released" class="form-control" value="{{ old('date_released', date('Y-m-d')) }}">
                </div>
                <div class="form-group">
            ...
            <div class="table-responsive" style="max-height: 480px; overflow-y: auto; border: 1px solid var(--dftm-border); border-radius: var(--radius-md);">
                <table class="dftm-table" id="availableItemsTable">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" style="text-align: center; color: var(--dftm-slate); padding: 32px;">No items currently available in stock to release.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="form-group" style="margin-top: 20px;">
                ...
                <textarea name="notes" class="form-control" rows="2" placeholder="Optional release notes">{{ old('notes') }}</textarea>
            </div>
        </div>

        <div class="card-footer">
            <a href="{{ route('encoder.outgoing.index') }}" class="btn btn-outline">
                <i class="bi bi-arrow-left"></i> Cancel
            </a>
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-send-check"></i> Process Outgoing Slip
            </button>
        </div>
    </div>
</form>
